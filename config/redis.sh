...
DAEMON=/home/deployer/redis/src/redis-server
REDIS_CLI=/home/deployer/redis/src/redis-cli
CONFIG_FILE=/home/deployer/redis/redis.conf
...
case "$1" in
  start)
    ...
    chown root:root $PIDFILE $LOGFILE
