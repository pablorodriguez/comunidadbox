...
class Workorder < ActiveRecord::Base
  attr_accessible  :budget_id, :vehicle_id, :company_id, :company_info, :performed, :payment_method_id, :comment, :services_attributes, :notes_attributes,:deliver,:deliver_actual,:user_id
