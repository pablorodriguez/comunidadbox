class AddStatusIdToServiceAndWorkorder < ActiveRecord::Migration
  def change
    ...
    Status.create(id: 1, company_id: 12, name: "Abierto", is_final: false)   
    Status.create(id: 2, company_id: 12, name: "En Proceso", is_final: false)    
    Status.create(id: 4, company_id: 12, name: "Finalizado", is_final: true)   
    Status.create(id: 7, company_id: 12, name: "Confirmado", is_final: false)
